        ...
        <div class="block-content " style="padding:15px;">
            <div class="content">
                ...
                <div class="block">
                    ...
                    <td class="text-secondary mb-0"><?php if($r['position']=="Admin") {echo '<span class="badge badge-sm bg-gradient-success">Admin</span>';} elseif ($r['position']=="Manager"){echo '<span class="badge badge-sm bg-gradient-warning">Manager</span>';} elseif($r['position'] == "Accounts") {echo '<span class="badge badge-sm bg-gradient-primary">Accounts</span>';}?></td>
                    ...
                    <td><a href="edit-user?userid=<?php echo $r['id'];?>"><i class="fa fa-pencil" aria-hidden="true"></i></a> | <a href="users.php?userid=<?php echo $r['id'];?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
