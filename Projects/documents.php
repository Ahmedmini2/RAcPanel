...
if(isset($_GET['project_id'])){
    $id = $_GET['project_id'];
    $select = mysqli_query($conn, "select * from project_documents WHERE `project_id` = '$id'");
}
?>
<!DOCTYPE html>
  ...
  <main class="main-content position-relative lg:max-height-vh-100 lg:h-100 mt-1 border-radius-lg overflow-hidden">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 ">
            <li class="breadcrumb-item text-sm ps-2"><a class="opacity-5 text-dark" href="javascript:;">مستندات المشروع</a></li>
    ...
    <div class="container-fluid py-4">
      <div class="row">
        ...
        <a href="add-document.php?project_id=<?=$id?>" class="btn bg-gradient-dark mb-0 col-md-2 col-sm-6 col-xs-6"> أضافة مستند جديد&nbsp;&nbsp; <i class="fas fa-plus"></i></a>
              ...
              <table class="table align-items-center mb-0" id="example">
                <thead>
                  <tr  class="text-center">
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" width="5%">تفاصيل المستند</th>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">صورة المستند</th>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">تاريخ الرفع</th>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <form action="../scripts/projects/delete-doc.php?id=<?php echo $r['id']; ?>" method="post">
