...
if (!empty($_GET['edit'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $c_date = $_POST['c_date'];
        //here
        $target_dir = "../Signed-Docs/Stock-Use-Bills/" . $id . "/";
        ...
        $update = "UPDATE `stock` SET `name_stock` = '$name_stock', `description` = '$description', `quantity` = '$quantity' , `used_quantity` = '$used_quantity' ,`price_per_piece` = '$price_per_piece' , `total_price` = '$total_price', `use_image` = '$filename',  `stock_date` = '$c_date' WHERE `id` = $id";
    ...
    $insert = "INSERT INTO stock (`id`, `name_stock`, `description`, `quantity` , `used_quantity` , `price_per_piece` , `total_price`, `use_image`,  `stock_date` , `created_at`) VALUES (NULL, '$name_stock', '$description', '$quantity', '$used_quantity', '$price_per_piece', '$total_price', '$filename','$c_date', NOW())";
                    ...
                    <form id="<?php echo $idAttr; ?>" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="ادخل اسم منتج" class="form-control" name="name_stock" value="<?php echo $name_stock; ?>">
                                </div>
                            </div>
