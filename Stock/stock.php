              ...
              <table class="table table-hover table-bordered align-items-center mb-0" id="example">
                ...
                <tbody>
                  ...
                  while ($r = mysqli_fetch_array($select)) {
                    $nq = $_POST['nq'];
                    $remaining_quantity = $r['quantity'] - $nq;
                  ...
                  ?>
                    ...
                    <tr class="text-center">
                      ...
                      <td data-label="الكمية المستهلكة" class="mb-0 text-sm text-secondary border-1"><input type="number" class="used-quantity-input" value="nq" id="nq" name="nq"/></td>
