          ...
          <ul class="navbar-nav me-auto ms-0 justify-content-end">
            ...
            <li class="nav-item dropdown ps-2 d-flex align-items-center px-4">
                <a href="javascript:;" class="nav-link text-body p-0" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <span id="notification-count" class="circle d-flex bg-danger text-white p-3 shadow position-absolute" data-tor="place.right place.top shift.up(50%) shift.right(50%)">0</span> <!-- Add this line -->
                </a>
