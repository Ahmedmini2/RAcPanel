...
<body class="g-sidenav-show rtl bg-gray-100">
  ...
  <main class="main-content position-relative lg:max-height-vh-100 lg:h-100 mt-1 border-radius-lg overflow-hidden">
    ...
    <div class="container-fluid py-4">
        <div class="row">
        <a href="add-bank-req.php" class="btn bg-gradient-dark mb-0 col-2"> أضافة طلب تعميد جديد&nbsp;&nbsp; <i class="fas fa-plus"></i></a>
        <div class="block-content " style="padding:15px;overflow-x: auto;white-space: nowrap;">
            <div class="content">
                ...
                <div class="block">
                    ...
                    <td><a href="bank-req-info.php?bank_req=<?php echo $r['id'];?>"><i class="fa fa-eye" aria-hidden="true"></i></a> | <a href="edit-accounts?bank_req=<?php echo $r['id'];?>"><i class="fa fa-pencil" aria-hidden="true"></i></a> | <a href="scripts/accounts/delete.php?bank_req=<?php echo $r['id'];?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
