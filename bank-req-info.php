...
<body class="g-sidenav-show rtl bg-gray-100">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link " href="company-banks.php">
                ...
                <span class="nav-link-text me-1">حسابات بنوك الشركة</span>
              </a>
            </li>
           <li class="nav-item">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg overflow-hidden">
    ...
    <div class="block-header bg-warning rounded">
       ...
       <button type="button" id="btn1" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
        ...
        <button type="button" id="btn3" class=" printing btn bg-gradient-primary" data-bs-toggle="modal2" data-bs-target="#exampleModal2">
        إرفاق \ عرض الملف
        </button>
    ...
    <div class="invoice-box">
			<table cellpadding="0" cellspacing="0">
				...
				<tr class="top">
					<td colspan="2">
						<table>
							<tr>
								<td class="title">
									<img
										src="assets/img/logos/logo-gold.png"
                  ...
                  حالة الطلب : <?php if($status==1){echo "<span class='badge badge-sm bg-gradient-success'>طلب تعميد جديد</span>";}elseif($status==2){echo "<span class='badge badge-sm bg-gradient-success'>تم تأكيد الطلب عن طريق المحاسب</span>";}else{echo "<span class='badge badge-sm bg-gradient-success'>تم التأكيد </span>";}?><br />
								</td>
							</tr>
						</table>
					</td>
