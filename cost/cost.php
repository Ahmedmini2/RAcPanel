  ...
  <main class="main-content position-relative lg:max-height-vh-100 lg:h-100 mt-1 border-radius-lg overflow-hidden">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 ">
            <li class="breadcrumb-item text-sm ps-2"><a class="opacity-5 text-dark" href="javascript:;">مركز تكلفة</a></li>
    ...
    <div class="container-fluid py-4">
      <div class="row">
        ...
        <a href="add-cost.php" class="btn bg-gradient-dark mb-0 col-md-2 col-sm-6 col-xs-6"> أضافة تكلفة جديد&nbsp;&nbsp; <i class="fas fa-plus"></i></a>
                ...
                <?php 
                  while ($r = mysqli_fetch_array($select)) {
                    ...
                    <tr class="text-center">
                      ...
                      <td class="mb-0 text-sm"><a href="../Signed-Docs/Cost-Bills/<?=$r['id']?>/<?=$r['image']?>"><?=$r['image']?></a></td>
