            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              ...
              <p class="text-danger text-center"><?php echo $call_login; ?></p>
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">ADMIN</h3>
                ...
                <div class="card-body">
                  <form role="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                    ...
                    <div class="text-center">
                      <button type="submit" name="login" class="btn bg-gradient-info w-100 mt-4 mb-0">تسجيل الدخول</button>
                    </div>
                  </form>
                </div>
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                   ليس لديك حساب ؟
                    <a href="javascript:;" class="text-info text-gradient font-weight-bold">تسجيل حساب</a>
                  </p>
                </div>
              </div>
            </div>
