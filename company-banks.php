        ...
        <div class="block-content " style="padding:15px;">
            ...
            <div class="block-header bg-warning  col-2  rounded">
                ...
                <div class="block">
                    ...
                    <td><a href="bank-req-info.php?bank_req=<?php echo $r['id'];?>"><i class="fa fa-eye" aria-hidden="true"></i></a> | <a href="edit-company-bank.php?bank_id=<?php echo $r['id'];?>"><i class="fa fa-pencil" aria-hidden="true"></i></a> | <a href="scripts/banks/delete.php?bank_id=<?php echo $r['id'];?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
