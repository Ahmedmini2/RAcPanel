      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">مرحبا !</h1>
            <p class="text-lead text-white">مرحبا بك في منصة ركن اميال لإدارة الاعمال</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left">
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="أسمك" aria-label="Name" aria-describedby="email-addon">
                </div>
                <div class="mb-3">
                  <input type="email" class="form-control" placeholder="البريد الالكتروني" aria-label="Email" aria-describedby="email-addon">
                </div>
                <div class="mb-3">
                  <input type="password" class="form-control" placeholder="كلمة المرور" aria-label="Password" aria-describedby="password-addon">
                </div>
                <div class="form-check form-check-info text-left">
                  <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked>
                  <label class="form-check-label" for="flexCheckDefault">
                    انا اوافق على <a href="javascript:;" class="text-dark font-weight-bolder">الشروط والقوانين</a>
                  </label>
                </div>
                <div class="text-center">
                  <button type="button" class="btn bg-gradient-dark w-100 my-4 mb-2">تسجيل حساب</button>
                </div>
                <p class="text-sm mt-3 mb-0">هل لديك حساب بالفعل? <a href="javascript:;" class="text-dark font-weight-bolder">سجل الدخول</a></p>
              </form>
            </div>
          </div>
        </div>
