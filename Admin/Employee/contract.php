        ...
        <div class="container-fluid py-4">
            ...
            <div class="invoice-box ">
                ...
                <div class="row ">
                    ...
                    <p>2- <strong><?= $user['name_ar'] ?></strong> ، الجنسية، <?php if($user['nationality'] == 'سعودي') echo'بسجل مدني رقم'; else{ echo 'بإقامة رقم';} ?> (<?= $user['id_number'] ?>) تاريخ الإصدار 1418/12/17 هـ ومصدره الرياض, والمقيم سكناً في مدينة الرياض, ويشار إليه فيما بعد بالطرف الثاني <?= $user['nationality'] ?>. </p>
