        ...
        <div class="container-fluid py-4">
            ...
            <div class="invoice-box ">
                ...
                <div class="row ">
                    ...
                    <p>2- <strong><?= $user['name_ar'] ?></strong> ، الجنسية <?= $user['nationality'] ?> ، <?php if($user['nationality'] == 'سعودي') echo'بسجل مدني رقم'; else{ echo 'بإقامة رقم';} ?> (<?= $user['id_number'] ?>) تاريخ الإصدار <?=$user['id_issue_date']?> ومصدره الرياض, والمقيم سكناً في مدينة <?=$user['id_source']?>, ويشار إليه فيما بعد بالطرف الثاني . </p>
