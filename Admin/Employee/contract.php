        ...
        <div class="container-fluid py-4">
            ...
            <div class="invoice-box ">
                ...
                <div class="row ">
                 ...
                 <p>2- <strong><?=$user['name']?></strong> ، <?=$user['id_number']?> الجنسية، بسجل مدني (<?=$user['nationality']?>) تاريخ الإصدار 1418/12/17 هـ ومصدره الرياض, والمقيم سكناً في مدينة الرياض, ويشار إليه فيما بعد بالطرف الثاني . </p>
                </div>
                <!-- == -->
