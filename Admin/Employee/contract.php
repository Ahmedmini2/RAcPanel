        ...
        <div class="container-fluid py-4">
            ...
            <div class="invoice-box ">
                ...
                <div class="row ">
                    ...
                    <p>بين كل من: </p>
                    <p>1- <strong>مؤسسة ركن أميال للمقاولات</strong> وهي مؤسسة سعودية برقم سجل تجاري (1010897903) بتاريخ 1400/1/1هـ, ويمثله في هذا العقد السيد / <?=$_SESSION['full_name']?>، بصفته المدير العام للمؤسسة ويشار إليه فيما بعد بالطرف الأول .</p>
                    ...
                    <p>قبل الطرف الثاني بالعمل لدى الطرف الأول بوظيفة ( <?= $user['position'] ?> ) , وراتب أساسي شهري قدره ( <?= $user['salary'] ?> ريال ) , <span id="con"> </span> Riyal يدفع في نهاية كل شهر ميلادي 
                    ...
                    <?php if ($user['tickets'] != 'لا يوجد') echo ' + تأمين قيمة تذاكر السفر '.$user['tickets'].' '; ?> 
                    <?php if ($user['extra_perc'] != 'لا يوجد') echo ' + حوافز سنوية حسب اللوائح المعتمدة داخل المؤسسة نسبة  '.$user['extra_perc'].' من قيمة اي مشروع يجلبه الطرف الثاني للمؤسسة '; ?> 
                    ...
                    <?php if($user['auto_renew'] == 'لا') echo 'ويتم تجديد هذا العقد بإنتهاء فترة العقد'; else { echo 'ويجدد هذا العقد تلقائياً' ; } ?> 
                    ...
                    <?php if($user['contract_type'] == 'دوام عن بعد') echo 'بدوام عن بعد و أن يحضر لمقر المؤسسة حسب مقتضيات العمل وحاجته،'; else{ echo 'بدوام '.$user['contract_type'].' و أن يحضر لمقر المؤسسة حسب مقتضيات العمل وحاجته ';}  ?>
