        ...
        <div class="container-fluid py-4">
            ...
            <tr class="details">
                <td colspan="2">
                    ...
                    <p>قبل الطرف الثاني بالعمل لدى الطرف الأول بوظيفة (<?=$user['position']?>)، وراتب أساسي شهري قدره (<?=$user['salary']?> ريال)، يدفع في نهاية كل شهر ميلادي <?php if($user['car_insurance'] == 'يوجد') echo ' + تأمين سيارة'; ?><?php if($user['gas_insurance'] == 'يوجد') echo ' + تأمين المحروقات للعمل'; ?><?php if($user['medical_insurance'] == 'تأمين شخصي') echo ' + تأمين شخصي فقط'; else if($user['medical_insurance'] == 'تأمين طبى له ولأفراد العائلة') echo '+ تأمين طبى له ولأفراد العائلة'; ?><?php if($user['phone_and_sim'] == 'يوجد') echo ' + تأمين جوال وشريحة إتصال'; ?><?php if($user['house_insurance'] == 'يوجد') echo ' + تأمين بدل سكن'; ?><?php if($user['tickets'] == 'لا يوجد') echo ''; else { echo ' + تأمين قيمة تذاكر السفر '.$user['tickets'].' '; ?><?php if($user['extra_perc'] == 'لا يوجد') echo ''; else { echo ' + حوافز سنوية حسب اللوائح المعتمدة داخل المؤسسة نسبة '.$user['extra_perc'].' من قيمة اي مشروع يجلبه الطرف الثاني للمؤسسة'; } ?></p>
