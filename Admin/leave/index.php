...
<body class="g-sidenav-show rtl .bg-gray-100 ">
    ...
    <main class="main-content position-relative lg:max-height-vh-100 lg:h-100 mt-1 border-radius-lg overflow-hidden" style="-webkit-overflow-scrolling: touch;overflow-y: scroll;">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">الاجازات</h6>
                </nav>
        ...
        <div class=" mb-4 p-3">
          <div class="">
            <h5 class="mb-1"> الاجازات </h5>
          </div>

          <a href="add-leave.php" class="btn bg-gradient-dark mb-0 col-md-2 col-sm-6 col-xs-6">طلب اجازة جديد&nbsp;&nbsp;
            <i class="fas fa-plus">
            </i>
          </a>
          </div>
