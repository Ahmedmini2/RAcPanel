                                ...
                                <table class=" display table table-hover table-bordered table-fixed" id="example">
                                    ...
                                    <thead class="bg-dark text-light text-center">
                                        <tr>
                                            ...
                                            <th class="  border-1 text-center">مجموع السلفيات</th>
                                            <th class="  border-1 text-center">مجموع المسدد</th>
                                            <th class="  border-1 text-center">مجموع المتبقي</th>
                                    ...
                                    <tbody class=" text-center">
                                        ...
                                        while ($r = mysqli_fetch_array($select)) {
                                            ...
                                            $total_adv += $r['amount'];
                                            $total_paid +=$r['advanced'];
                                            $total_rem = $total_adv - $total_paid
                                        ?>
                                            <tr>
                                                ...
                                                <td class="border-1"><?= $total_paid ?></td>
