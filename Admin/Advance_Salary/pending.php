...
$select = mysqli_query($conn, "select * from advance_salary WHERE status = 'Pending'");
?>
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">قيد الانتظار </h6>
                </nav>
                                    ...
                                    <tbody class=" text-center">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="border-1">
                                                    <a href="../../scripts/Advance_Salary/status.php?Approved=<?= $r['id'] ?>"><i class="fa fa-check" aria-hidden="true"></i></a> |
                                                    <a href="../../scripts/Advance_Salary/status.php?Declined=<?= $r['id'] ?>"><i class="fa fa-times" aria-hidden="true"></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
