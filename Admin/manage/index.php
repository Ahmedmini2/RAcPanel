        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">اداره</h6>
                </nav>
                            ...
                            <div class="table-responsive p-0">
                                <table class="table table-hover table-bordered table-fixed" id="example">
                                    ...
                                    <tbody class=" text-center">
                                        ...
                                        <tr>
                                            <th scope="row">1</th>
                                            <td class="border-1">Ahmed Othman</th>
                                            <td class="border-1">ahmed_mini</td>
                                            <td class="border-1">ahmedothman.rc@gmail.com</td>
